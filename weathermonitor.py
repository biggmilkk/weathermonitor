...
if callable(scraper):
    try:
        ...
        st.write("[DEBUG] NWS scraper returned type:", type(data))
        st.write("[DEBUG] NWS scraper returned value:", data)
    ...
    st.error("[ERROR] get_scraper('api.weather.gov') returned None")
